                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Enter new student details
                                    </p>

                                    <form class="mx-1 mx-md-4" action="feccth" method="post">
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <label class="form-label" for="form3Example3c">Enter phone
                                                    number</label>
                                                <input type="number" id="form3Example3c" class="form-control"
                                                    name="phone_no" maxlength="10"/ size="10">
